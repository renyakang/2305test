...
parser.add_argument('--data', type=str, required=True, default='power', help='data')
parser.add_argument('--root_path', type=str, default='E://Informer202//ETDataset-main//ETT-small//', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='power.csv', help='data file')
parser.add_argument('--features', type=str, default='MS', help='forecasting task, options:[M, S, MS]; M:multivariate predict multivariate, S:univariate predict univariate, MS:multivariate predict univariate')
parser.add_argument('--target', type=str, default='总有功功率', help='target feature in S or MS task')
